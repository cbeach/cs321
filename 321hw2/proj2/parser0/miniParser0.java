/* Generated By:JavaCC: Do not edit this line. miniParser0.java */
package parser0;
//import ast.*;


public class miniParser0 implements miniParser0Constants {
  ...
  static final public void MethodDeclTail() throws ParseException {
    if (jj_2_13(5)) {
      Type();
      jj_consume_token(ID);
  ...
  static final public void ElmType() throws ParseException {
    if (jj_2_20(5)) {
  ...
  static final public void StatementLvalueTail() throws ParseException {
    if (jj_2_36(5)) {
      jj_consume_token(ASSIGN);
      FullExpr();
      jj_consume_token(DELIMITER);
  ...
  static final public void FullExpr() throws ParseException {
    if (jj_2_39(5)) {
  ...
  static final public void FullExprNewTail() throws ParseException {
    if (jj_2_42(5)) {
      jj_consume_token(ID);
      jj_consume_token(LPAREN);
      if (jj_2_41(5)) {
  ...
  static final public void OrTail() throws ParseException {
    if (jj_2_44(5)) {
      jj_consume_token(OR);
      AndExpr();
      OrTail();
  ...
  static final public void AndTail() throws ParseException {
    if (jj_2_45(5)) {
  ...
  static final public void ArithTail() throws ParseException {
    if (jj_2_49(5)) {
      if (jj_2_47(5)) {
  ...
  static private boolean jj_3_19() {
    ...
    if (jj_scan_token(R_SQUARE_BRACKET)) return true;
    return false;
  }
  ...
  static private boolean jj_3_75() {
    if (jj_scan_token(GRETER_OR_EQL)) return true;
    return false;
  }

  static private boolean jj_3_74() {
    if (jj_scan_token(GRETER_THAN)) return true;
    return false;
  }
  ...
  static private boolean jj_3_73() {
    if (jj_scan_token(GREATER_OR_EQL)) return true;
    return false;
  }
  ...
  static private boolean jj_3_71() {
    if (jj_scan_token(NOT_EQL)) return true;
    return false;
  }
  ...
  static public miniParser0TokenManager token_source;
  ...
  public miniParser0(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public miniParser0(java.io.InputStream stream, String encoding) {
    ...
    token_source = new miniParser0TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public miniParser0(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public miniParser0(miniParser0TokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(miniParser0TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
