// Class record for MINI v1.5. (Jingke Li)
//
package symbol;
import ast.*;
import java.util.*;
...
public class ClassRec {
  ...
  public void addMethod(Id cid, Id mid, Type rtype) throws SymbolException {
    MethodRec m = methods.put(mid.s, new MethodRec(cid, mid, rtype));
    if (m != null)
